namespace UI
{
    public class TextHelper
    {
        ...
        public static string BlueKeyPickUp => "<#395BFF>You Picked up Blue key";
        public static string RedKeyPickUp => "<#FF1100>You Picked up Red key";
        public static string YellowKeyPickUp => "<#FFCC21>You Picked up Yellow key";
